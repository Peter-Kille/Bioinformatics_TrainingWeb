...
subtitle: "Makign Sense out of Sequence"
...
```{bash}
module load prokka/1.14.6-mframqo
```
...
<iframe data-external="1" src="https://cardiff.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=d146a6c1-7a9e-4b20-ad51-b4c4011663e3&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay">
...
```{bash}
module load barrnap/0.9-ypa5cto
...
```{bash}
module load bedtools2/2.31.1-z2zkxtk
```
...
```{bash}
module load blast-plus/2.14.1-qxsspbk
```
...
```{bash}
module load minimap2/2.28-mpg3455
```
