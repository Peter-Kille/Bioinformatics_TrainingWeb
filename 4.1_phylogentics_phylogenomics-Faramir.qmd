...
figtree
```
An interactive window will now open for you to use if you are using X11 enabled mobaxterm.  If you are using a mac or linux shell you will need to install [figtree](http://tree.bio.ed.ac.uk/software/figtree/) locally and download the newick file (nwk suffix). 
