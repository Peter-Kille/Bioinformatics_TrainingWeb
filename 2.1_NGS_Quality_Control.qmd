...
In ~/classdata there is a folder called datasets.  Copy this folder across to your ~/mydata directory

```{bash}
cp -R ~/classdata/datasets ~/mydata/datasets
```

In side this folder you will find two data sets: mitochondrial and prokaryote. As you become more confident try and write programs that perform the following processes:

1. fastqc rawdata

2. fastqc rawdata, fastp trim, fastqc trimdata and generate a multiqc summary
:::
