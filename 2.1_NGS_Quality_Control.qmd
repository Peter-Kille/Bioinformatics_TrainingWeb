...
You should see that the list includes fastqc \[**NB. I have note added the version - it will use the default but I will have no record of the version it has used**\] To load this module, simply type
...
fastp -q 20 -u 10 --cut_right -i Illumina_R1.fastq -I Illumina_R2.fastq -o Illumina_trim_R1.fastq -O Illumina_trim_R2.fastq --detect_adapter_for_pe
  --html Illumina_fastp.html --json Illumina_fastp.json --thread 4
```

Script - multi-line line easy to read version:
...
fastp -q 20 -u 10 \
      ...
      -i Illumina_R1.fastq \
      -I Illumina_R2.fastq \
      -o Illumina_trim_R1.fastq \
      -O Illumina_trim_R2.fastq \
...
::: {.callout-note collapse="true"}
## Worked Example: Fastqc loop

Step 1: Navigate to Session 2 Looping folder

```{bash}
cd ~/mydata/Session2/looping/
```

Step 2: Make a rawdata directory and move in all fastq.gz sequences
...
Step 3: Create a program to make a sample list file

[generate sample list](https://peter-kille.github.io/Bioinformatics_TrainingWeb/1.3_Commandline_Tools_and_Scripting.html#sec-loops-loop-to-create-a-samplelist-from-rawdata-folder)

Step 4: Edit Loop using sample list to include multiqc

[execute program on sample list](https://peter-kille.github.io/Bioinformatics_TrainingWeb/1.3_Commandline_Tools_and_Scripting.html#sec-program-execution-loop-f-samplelist)

- Add variables for raw data directory, create folder for rawqc results and make variable for rawqcdir
...
- Edit module load and module unload
...
- Add the fastqc command to middle of loop
...
Here's a video of me building these scripts for start to finish:

<iframe data-external="1" src="https://cardiff.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=096638d4-ff06-4467-8bcd-b4c00117084b&amp;autoplay=false&amp;offerviewer=true&amp;showtitle=true&amp;showbrand=true&amp;captions=false&amp;interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player">
...
::: {.callout-note collapse="true"}
## Worked Example - Viral: rawdata QC triming and post trim QC

<iframe data-external="1" src="https://cardiff.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=b5e5d487-6d07-4a89-a359-b4c0012fcf51&amp;autoplay=false&amp;offerviewer=true&amp;showtitle=true&amp;showbrand=true&amp;captions=false&amp;interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player">
...
Do the same for the prokayotic and Mitochondrial data!
:::
