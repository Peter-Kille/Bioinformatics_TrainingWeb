...
[Introduction to Linux - Powerpoint](https://tinyurl.com/7b8hmhsk)
...
3.  \[Extension\] Do a 'long list' (-l) of these files and see the difference in sizes. Add the 'human readable' parameter/flag (-h) to help read the sizes.
:::
...
## Do not move on to part 2 until after the second lecture
