...
## Loops loop to create a SampleList from rawdata folder
...
printf ${name}\t${name}_R1.fastq\t${name}_R1.fastq\n" >> samplelist.txt
...
## Loop to execute a program on samplelist
...
#set present working directory as the location of script....all folder will be related to this directory
workdir=$(pwd)
#create varible for sample list saved in workdir
