...
WE have the ability to interact with the HPC through a full OnDemand graphical interface - this is only recommended is essential for graphical only programs and it uses significant amount of computation resources to power the interface leaving less resource to perform more interesting informatic tasks !!
