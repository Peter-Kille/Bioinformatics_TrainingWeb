...
Now re-enter you username and input the pass phase you have been provided. You should now see the RStudio page. Note the file listed in the right hand lower tab are files on your virtual machine on the server, ***not*** your local computer.
