...
This element of the course introduces you the the computational resources that have been provided for you to perform the training. It also covers a light guide to logging in to the research platforms at Cardiff School of Biosciences. If you are a researcher at Cardiff wanting to gain access to HPC please contact our [Biocompute team](http://hpc.bios.cf.ac.uk/) and join the bioinformatics Teams community. If you are outside Cardiff - find out about your local HPC provision. If there is none locally look into cloud service such as AWS and Google .... many of these provide limited free options which can help you to learn.
...
[Generation of Differentially Expressed Gene (DEG) Lists](https://peter-kille.github.io/Bioinformatics_TrainingWeb/5.3_DEG_Generation.html)
...
[Extension: Functional Interpretation of DEGs](https://peter-kille.github.io/Bioinformatics_TrainingWeb/5.4_DEG_Functional_Interpretation.html)
...
More detail on coding in Linux can be found at http://linuxcommand.org/lc3_learning_the_shell.php

For a more in depth Linux tutorial with exercises, see https://swcarpentry.github.io/shell-novice/01-intro/ 

Good cheat sheet to refer to http://cheatsheetworld.com/programming/unix-linux-cheat-sheet/

Lots of interactive bioinformatics tutorials can be found at https://sandbox.bio/
