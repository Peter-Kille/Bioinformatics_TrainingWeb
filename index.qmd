...
There is a global bioinformatics community online and actively posting in chat rooms. Often the technical problem you are having or the error code that has appeared has been seen before and you can find people have posted solutions in old threads. [Stack Overflow](https://stackoverflow.com/) is a great place to start. You can post questions yourself and when you get more experienced find some time to contribute and help others.
...
If you are in Cardiff University, we have a monthly Data Coffee Club at 11:00 in the School of Biosciences staff room on the first Friday of every month. All staff and postgraduate researchers with an interest in data are welcome; come along and chat with like-minded people over coffee and cake.  
...
One area is which LLMs are likely to prove very useful is in debugging. Error messages usually contain useful information, but not necessarily in a wording accessible to a beginner. LLMs can be very useful for helping to identify and diagnose bugs in code.
...
When you are zoomed in, the resources appear in colour-coded spheres - red are lectures, purples are workshop materials and light green are web-resources. If you click again you will zoom in to see specific links to the relevant training material.
...
This element of the course introduces you the the computational resources that have been provided for you to perform the training. It also covers a light guide to logging in to the research platforms at Cardiff School of Biosciences. If you are a researcher at Cardiff wanting to gain access to HPC please contact our [Biocompute team](http://hpc.bios.cf.ac.uk/docs/help/contacts) and join the bioinformatics Teams community. If you are outside Cardiff - find out about your local HPC provision. If there is none locally look into cloud service such as AWS and Google .... many of these provide limited free options which can help you to learn.

## Session 1. Linux: The basics

This introduces you to the command line - yes, no more clicking on icons as from here on in, it is all about writing commands!!

[Introduction to Linux](https://peter-kille.github.io/Bioinformatics_TrainingWeb/1.1_Introduction_to_Linux.html)

This represents a rapid run through of the basics you need to get going on the command line, with lots of useful information and some basic exercises - copying/moving files and learning about your Linux environment. This workshop is designed to get you started quickly.

This session gives detail about the Linux basics, covering navigating around your Linux system (it has some graphical representations of your file system), auto-completion, file permissions and the fundamental anatomy of a linux command. We cover simple commands (copy/move ect.), how to preview files (less/cat/head/tail) and how to edit files (we use Nano but touch on using Vi).
...
## Session 2. NGS Data Manipulation: Checking and improving quality
...
## Session 3. Genomes: From sequences to assemblies.

[Genome Assembly](https://peter-kille.github.io/Bioinformatics_TrainingWeb/3.1_genome_assembly.html)
...
[Extension: Hybrid Assemblies](https://peter-kille.github.io/Bioinformatics_TrainingWeb/3.2_hybrid_assemblies.html)
...
## Session 4. Genome visualisation and annotation

[Genome Annotation and Visualisation](https://peter-kille.github.io/Bioinformatics_TrainingWeb/4.1_Genome_visualisation_and_annotation.html)
...
[Extension: Annotating Mitochodria](https://peter-kille.github.io/Bioinformatics_TrainingWeb/4.2_Annotating_mitochondria.html)
...
## Session 5. Building phylogenies

[Phylogenetics and Phylogenomics](https://peter-kille.github.io/Bioinformatics_TrainingWeb/5.1_phylogentics_phylogenomics.html)

The taxonomic relationships between organisms can be derived through the genetic differences between them. This workshop provides a refresher of the basic principles and then provides examples of how to derive phylogenetic trees from single genes to whole genomes. Ultimately, the more global the information used to generate a phylogeny the more resolution/understanding you have about the relationship between organisms at the level of the individual or population.

[Extension: more phylogenetics and phylogenomics](https://peter-kille.github.io/Bioinformatics_TrainingWeb/5.2_phylogentics_phylogenomics_extension.html)

More practice at building phylogenies.

## Session 6. Transcriptomics

[RNAseq Data Processing](https://peter-kille.github.io/Bioinformatics_TrainingWeb/6.1_RNAseq_processing.html)
...
[Generation of Differentially Expressed Gene (DEG) Lists](https://peter-kille.github.io/Bioinformatics_TrainingWeb/6.2_DEG_analysis.html)

Performing quality control and provisional data visualisation are essential steps on before generating differentially expressed gene lists. Here we use [SARTools](https://github.com/PF2-pasteur-fr/SARTools), developed at the Pasteur Institute, to illustrate best practice in transcriptome analysis. We also include multivariate approaches to data visualization such as PCA and HCA (hierarchical clustering analysis).

[Extension: Functional Interpretation of DEGs](https://peter-kille.github.io/Bioinformatics_TrainingWeb/6.3_DEG_Functional_Interpretation.html)
...
## Session 7. Microbial community analysis

[Metabarcoding](https://peter-kille.github.io/Bioinformatics_TrainingWeb/7.1_metabarcoding.html)

Amplification of short, phylogenetically informative sections of DNA can be used to generate community profiles. This course introduces the concepts of metabarcoding targets that are used for different phylogenetic groups (16S for bacteria, ITS for fungal, *RbcL* for algae and COI/18S for other eukaryotes). Data analysis uses (QIIME2)\[https://qiime2.org/\] to navigate you through preliminary metabarcoding data analysis.
...
Lots of bioinformatics exercises and tutorials https://sandbox.bio/
